...
A more in-depth tutorial can be found [here](https://egr95.github.io/R-codacore/), but it will require having gone through the installation steps below first.
